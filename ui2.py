...
class GUIFrame(Frame):
    ...
    def __init__(self, parent):
        ...
        self.ExitButton = Button(self.frame4, text="退出", font="Toahoma 10", command = self.ExitButton)
        ...
        self.localtimeCheck = Checkbutton(self.frame5, variable=self.chooseTime, font = "Toahoma 10", command = self.decideLocaltime)
        ...
        self.countText = Button(self.frame6, text="计算", font="Toahoma 10", command = self.contentLenCount, width = 10)
        ...
        self.autoCheck = Checkbutton(self.frame7, variable=self.autoCheck_choose, font = "Toahoma 10", command = self.decideLocaltime)

        self.autoCheck.pack(side=LEFT, padx=3)

        self.telCheck = Checkbutton(self.frame7, variable=self.telType_choose, font = "Toahoma 10", command = self.decideLocaltime)
        ...
        self.autoButton = Button(self.frame7, text="生成", font="Toahoma 10", command = self.submitButton)
